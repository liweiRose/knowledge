...
let obj3 = {...obj};
obj.name = 'cl';
obj.habbes.push('love');
console.log(obj);  
// {name:'cl',age:18,habbes:['book','pan','love']}
console.log(obj2);
// {name:'liwei',age:18,habbes:['book','pan','love']};
console.log(obj3);
// {name:'liwei',age:18,habbes:['book','pan','love']};
```
...
2.实现一个 deepClone 函数
  ...
  - 4.考虑循环引用的问题
```js
fonction deepClone(obj,hush=new WeakMap()){
